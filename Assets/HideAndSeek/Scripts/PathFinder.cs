...
//            GameManager.instance.WriteFileA("test.txt", "\n");

//            GameManager.instance.WriteFileA("test.txt", this.searchParameters.StartLocation + "\n");
//            GameManager.instance.WriteFileA("test.txt", this.searchParameters.EndLocation + "\n");
//            for (int y = 0; y < this.height; y++)
//            {
//                for (int x = 0; x < this.width; x++)
//                {
////                    string str = x.ToString() + "," + y.ToString() + " ";
//                    string str = string.Format("{0:d},{1:d} ({2,2:f}) ", x, y, this.nodes[x, y].F);
//                    if (x == this.width - 1) str += "\n";
//                    GameManager.instance.WriteFileA("test.txt", str);
//                }
//            }           
        }
